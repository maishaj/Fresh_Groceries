...
const Cart = () => {
  ...
  return products.length > 0 && cartItems ? (
    <div className="flex flex-col md:flex-row mt-16 text-left gap-10">
      {/* LEFT SIDE */}
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart{" "}
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 border border-gray-300/70">
        ...
        <div className="relative flex gap-2 mt-2">
          <p className="text-gray-500 break-words line-clamp-2 md:line-clamp-none w-[85%]">
            {selectedAddress
              ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.district}, ${selectedAddress.country}`
              : "No address found"}
          </p>
          ...
          {showAddress && (
            <div className="absolute top-12 bg-white border border-gray-300 text-sm w-full z-10">
              {addresses.map((address, index) => (
                <p
                  key={index}
                  onClick={() => {
                  ...
                  className="p-2 text-gray-500 hover:bg-gray-100 break-words"
                >
                  {address.street}, {address.city}, {address.district},{" "}
                  {address.country}
                </p>
              ...
              <p
                onClick={() => navigate("/add-address")}
                className="text-primary text-center p-2 cursor-pointer hover:bg-primary-dull"
              >
                Add address
              </p>
            </div>
